...
const ImageBackground = styled.div({
  width: "100%",
  backgroundImage: `url(https://www.adobe.com/es/express/feature/image/media_16ad2258cac6171d66942b13b8cd4839f0b6be6f3.png})`,
...
const HeaderAbout = () => {
  return (
    <>
      <ImageBackground className={styles.bgImage}>
        <ShadowContent>
          <ContainerText>
            <Grid container>
              <Grid item xs={11}>
